...
<div class="container" id="input">
    ...
    echo '<input type="hidden"id="id" value="'.$data->id().'">'
    ...
    <?php
		echo '<input type="text" class="form-control" id="libelle" value="'.$data->libelle().'" aria-describedby="libelleHelp">';
    ?>
	...
	<div class="form-group">
		<label for="N">N:</label>
		<?php
			echo '<input type="text" class="form-control" id="N" value="'.$data->nb_points().'"aria-describedby="libelleHelp">'
		?>
	...
	<div class="form-group">
		...
		<?php
			echo '<input type="text" class="form-control" id="corde" value="'.$data->corde().'"aria-describedby="libelleHelp">'
		?>
	...
	<div class="form-group">
		...
		<?php
			echo '<input type="text" class="form-control" id="Tmax" value="'.$data->tmax_pourcent().'"aria-describedby="libelleHelp">'
		?>
	...
	<div class="form-group">
		...
		<?php
			echo '<input type="text" class="form-control" id="Fmax" value="'.$data->fmax_pourcent().'"aria-describedby="libelleHelp">'
		?>
